scoreboard players remove @s thurgie_resources 1
execute if score @s thurgie_resources < 0 thurgie_resources run scoreboard players set @s thurgie_resources 0
